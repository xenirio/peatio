...
class Member < ApplicationRecord
  ...
  def payment_address(wallet_id, remote = false)
    ...
    pa = PaymentAddress.find_by(member: self, wallet: wallet, blockchain_key: wallet.blockchain_key, remote: remote)

    if pa.blank?
      pa = payment_addresses.create!(wallet: wallet, blockchain_key: wallet.blockchain_key)
