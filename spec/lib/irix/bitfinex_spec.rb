...
describe Irix::Bitfinex do
  ...
  context "#ws_read_public_message" do
    ...
    context 'trade message' do
      ...
      it do
        ...
        bitfinex.stubs(:detect_trade).returns(msg)
        bitfinex.ws_read_public_message(msg)
      end
    end
    ...
    context 'book message' do
      ...
      it do
        ...
        bitfinex.stubs(:detect_order).returns(msg)
        bitfinex.ws_read_public_message(msg)
      end
    end
  end
  ...
  context "Public trades" do
    ...
    it do
      bitfinex.stubs(:notify_public_trade).returns(trade)
  ...
  context "OrderBook proxy" do
    ...
    it do
      ...
      bitfinex.stubs(:publish_snapshot)
