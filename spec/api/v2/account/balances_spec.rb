...
describe API::V2::Account::Balances, type: :request do
  ...
  let(:response_body) { { 'currency' => 'eth', 'balance' => '30.5', 'locked' => '0.0', 'account_type' => 'spot', 'deposit_address' => nil } }
    ...
    context 'all balances' do
      ...
      it 'returns current user balances' do
        ...
        expect(result).to contain_exactly(
                              { 'currency' => 'btc', 'balance' => '5.0', 'locked' => '5.0', 'account_type' => 'spot', 'deposit_address' => nil },
                              { 'currency' => 'eth', 'balance' => '30.5', 'locked' => '0.0', 'account_type' => 'spot',  'deposit_address' => nil },
                              { 'currency' => 'usd', 'balance' => '0.0', 'locked' => '0.0', 'account_type' => 'spot',  },
                              { 'currency' => 'trst', 'balance' => '0.0', 'locked' => '0.0', 'account_type' => 'spot',  'deposit_address' => nil },
                              { 'currency' => 'ring', 'balance' => '0.0', 'locked' => '0.0', 'account_type' => 'spot',  'deposit_address' => nil },
